...
namespace bfjit
{
    ...
    {
        // mprotect() works only on page boundaries. Instead of doing
        // everything in one really clever expression, I introduced a lot
        // of variables to make things more clear.
        ...
        using fun_type = void (*)(uint8_t *, int (*)(), int (*)(int));
